      ...
      'boundaries/element-types': [
        'error',
        {
          ...
          rules: [
            ...
            { from: 'shared-pattern', allow: ['shared-ui', 'shared-models', 'shared-utils', 'shared-public-api'] },
            { from: 'shared-services', allow: ['shared-models', 'shared-utils', 'environment'] },
            { from: 'shared-data-access', allow: ['shared-models'] },
            { from: 'shared-models', allow: [] },
            { from: 'shared-utils', allow: ['shared-models', 'shared-services'] },
            ...
            { from: 'web-ui', allow: ['shared-ui', 'shared-models', 'shared-models-api'] },
            {
              from: 'web-pattern',
              allow: ['web-core', 'shared-ui', 'shared-pattern', 'shared-public-api'],
            },
            ...
            { from: 'admin-ui', allow: ['shared-ui', 'shared-models', 'shared-models-api'] },
            {
              from: 'admin-pattern',
              allow: ['admin-core', 'shared-ui', 'shared-pattern', 'shared-public-api'],
            },
            ...
            { from: 'mfe-ui', allow: ['shared-ui', 'shared-models', 'shared-models-api'] },
